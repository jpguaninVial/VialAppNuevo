...
class ImprovedRetiroParcialController extends GetxController {
  static const String LOADING_KEY = 'retiro_parcial';
  ...
  ImprovedRetiroParcialController(Usuario usuario) {
    this.usuario = usuario;
  }

  /// Registro de retiro parcial con validación de conexión obligatoria
  Future<void> registrarRetiroParcial(BuildContext context, Usuario usuario) async {
    ...
    LoadingController.to.setLoading(
      LOADING_KEY,
      message: 'Procesando retiro parcial...'
    );
    ...
    Get.dialog(
      AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text('No se puede procesar el retiro parcial sin conexión al servidor.'),
            SizedBox(height: 16),
            Container(
  ...
  Future<void> _handleTransactionResult(TransactionResult result) async {
    if (result.success) {
      Get.snackbar(
        'Transacción Exitosa',
        'El retiro parcial ha sido registrado correctamente',
    ...
    await Get.dialog(
      AlertDialog(
        ...
        content: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('No se pudo procesar el retiro parcial:'),
            SizedBox(height: 8),
            Text(
  ...
  void _handleError(dynamic error) {
    Get.snackbar(
      'Error Inesperado',
      'Ocurrió un error al procesar el retiro parcial',
      backgroundColor: Colors.red,
      colorText: Colors.white,
    );
  }
