...
class EditarTransaccionController extends GetxController {
  ...
  EditarTransaccionController(Movimiento movimiento) {
    ...
    movimiento.entrega20D == '0'
        ? movimiento.entrega20D = ''
        : billetes20EntregaController.text = movimiento.entrega20D ?? '';
    movimiento.entrega10D == '0'
        ? movimiento.entrega10D = ''
        : billetes10EntregaController.text = movimiento.entrega10D ?? '';
    movimiento.entrega5D == '0'
        ? movimiento.entrega5D = ''
        : billetes5EntregaController.text = movimiento.entrega5D ?? '';
    movimiento.entrega1D == '0'
        ? movimiento.entrega1D = ''
        : billetes1EntregaController.text = movimiento.entrega1D ?? '';
    movimiento.entrega50C == '0'
        ? movimiento.entrega50C = ''
        : Moneda50EntregaController.text = movimiento.entrega50C ?? '';
    movimiento.entrega25C == '0'
        ? movimiento.entrega25C = ''
        : Moneda25EntregaController.text = movimiento.entrega25C ?? '';
    movimiento.entrega10C == '0'
        ? movimiento.entrega10C = ''
        : Moneda10EntregaController.text = movimiento.entrega10C ?? '';
    movimiento.entrega5C == '0'
        ? movimiento.entrega5C = ''
        : Moneda5EntregaController.text = movimiento.entrega5C ?? '';
    movimiento.entrega1C == '0'
        ? movimiento.entrega1C = ''
        : Moneda1EntregaController.text = movimiento.entrega1C ?? '';
  ...
  void editarTransaccion(BuildContext context, Movimiento movimientos) async {
    try {
      ...
      String entrega20D = billetes20EntregaController.text.isEmpty
          ? '0'
      ...
      if (responseApi.statusCode == 201) {
        CustomToast.showSuccess(
          ...
          message: 'La transacción ha sido editada exitosamente',
        );
